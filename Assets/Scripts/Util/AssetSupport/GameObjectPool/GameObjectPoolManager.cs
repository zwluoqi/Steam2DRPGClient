...
public class GameObjectPoolManager : MonoBehaviour
{
	...
	private GameObjectPool CreateGameObjectPool(GameObject obj, int num)
    {
        if (null == obj)
        {
            XZXDDebug.LogWarning("error! fail to run GameObjectPoolManager.New( null )");
			return null;
        }
    ...
    public void Unspawn(ref GameObject obj)
    {
        ...
        {
			XZXDDebug.LogWarning(string.Format("ObjectPoolManager.Unspawn: {0}; pool not Registed!", obj.name));
            Destroy(obj);
        }
    ...
    public void UnspawnAndDestory(GameObject obj)
    {
        ...
        {
            XZXDDebug.LogWarning(string.Format("ObjectPoolManager.UnspawnAndDestory: {0}; pool not Registed!", obj.name));
            Destroy(obj);
        }
    }

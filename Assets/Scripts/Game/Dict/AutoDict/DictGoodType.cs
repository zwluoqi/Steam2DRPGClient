...
public partial class DictGoodType
{
    ...
    public Model GetModel(int classId)
    {
        if (m_dict == null)
        {
            Debug.LogError("DictGoodType m_dict Is Null");
            return null;
        }
        else
        {
    ...
    private void DoParse(DictFileReader fileReader)
    {
        ...
        do
        {
            ...
            model.top_meun = DictTypeConvert.ParseString(str[fileReader.typeName2Index["top_meun"]]);
            ...
            {
                Debug.LogError("DictGoodType Parse:Same Key = " + model.classId);
            }

...
public partial class DictChapterActivityCountReward
{
    ...
    public class Model
    {
     ...
     /// <summary>
        /// 次数档位
        /// </summary>
        public XorLong counter_xor;
     /// <summary>
        /// 次数档位
        /// </summary>
        public long counter{
            get{
                return counter_xor.val;
            }
        }
     /// <summary>
        /// 奖励档位
    ...
    public Model GetModel(int id)
    {
        if (m_dict == null)
        {
            Debug.LogError("DictChapterActivityCountReward m_dict Is Null");
            return null;
        }
        else
        {
    ...
    {
        return "dict_chapter_activity_count_reward.txt";
    }
    ...
    private void DoParse(DictFileReader fileReader)
    {
        ...
        do
        {
            ...
            model.counter_xor = new XorLong(DictTypeConvert.ParseLong(str[fileReader.typeName2Index["counter"]]),fileReader.randomUtil);
            ...
            {
                Debug.LogError("DictChapterActivityCountReward Parse:Same Key = " + model.id);
            }

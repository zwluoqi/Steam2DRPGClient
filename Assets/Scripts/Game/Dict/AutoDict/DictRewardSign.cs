...
public partial class DictRewardSign
{
    ...
    public class Model
    {
     ...
     /// <summary>
        /// 月份
        /// </summary>
        public XorInt month_xor;
     /// <summary>
        /// 月份
        /// </summary>
        public int month{
            get{
                return month_xor.val;
            }
        }
     /// <summary>
        /// 天数
        /// </summary>
        public XorInt day_xor;
     /// <summary>
        /// 天数
        /// </summary>
        public int day{
    ...
    public Model GetModel(int id)
    {
        if (m_dict == null)
        {
            Debug.LogError("DictRewardSign m_dict Is Null");
            return null;
        }
        else
        {
    ...
    private void DoParse(DictFileReader fileReader)
    {
        ...
        do
        {
            ...
            model.month_xor = new XorInt( DictTypeConvert.ParseInt(str[fileReader.typeName2Index["month"]]),fileReader.randomUtil);
            model.day_xor = new XorInt( DictTypeConvert.ParseInt(str[fileReader.typeName2Index["day"]]),fileReader.randomUtil);
            ...
            {
                Debug.LogError("DictRewardSign Parse:Same Key = " + model.id);
            }

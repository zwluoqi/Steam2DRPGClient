...
public partial class DictNameLast
{
    ...
    public Model GetModel(int id)
    {
        if (m_dict == null)
        {
            Debug.LogError("DictNameLast m_dict Is Null");
            return null;
        }
        else
        {
    ...
    private void DoParse(DictFileReader fileReader)
    {
        ...
        do
        {
            ...
            model.lastName = DictTypeConvert.ParseString(str[fileReader.typeName2Index["lastName"]]);
            ...
            {
                Debug.LogError("DictNameLast Parse:Same Key = " + model.id);
            }

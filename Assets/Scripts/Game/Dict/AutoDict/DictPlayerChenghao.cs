...
public partial class DictPlayerChenghao
{
    ...
    public Model GetModel(int id)
    {
        if (m_dict == null)
        {
            Debug.LogError("DictPlayerChenghao m_dict Is Null");
            return null;
        }
        else
        {
    ...
    {
        return "dict_player_chenghao.txt";
    }
    ...
    private void DoParse(DictFileReader fileReader)
    {
        ...
        do
        {
            ...
            model.jihuo = DictTypeConvert.ParseString(str[fileReader.typeName2Index["jihuo"]]);
            model.peidai = DictTypeConvert.ParseString(str[fileReader.typeName2Index["peidai"]]);
            model.tasks = DictTypeConvert.ParseArrayString(str[fileReader.typeName2Index["tasks"]]);
            ...
            {
                Debug.LogError("DictPlayerChenghao Parse:Same Key = " + model.id);
            }

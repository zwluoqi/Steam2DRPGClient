...
public partial class DictMenpaibossRankReward
{
    ...
    public class Model
    {
     ...
     /// <summary>
        /// 最小排名
        /// </summary>
        public XorInt minRank_xor;
     /// <summary>
        /// 最小排名
        /// </summary>
        public int minRank{
            get{
                return minRank_xor.val;
            }
        }
     /// <summary>
        /// 最大排名
        /// </summary>
        public XorInt maxRank_xor;
     /// <summary>
        /// 最大排名
        /// </summary>
        public int maxRank{
            get{
                return maxRank_xor.val;
            }
        }
     /// <summary>
        /// 奖励
    ...
    public Model GetModel(int id)
    {
        if (m_dict == null)
        {
            Debug.LogError("DictMenpaibossRankReward m_dict Is Null");
            return null;
        }
        else
        {
    ...
    {
        return "dict_menpaiboss_rank_reward.txt";
    }
    ...
    private void DoParse(DictFileReader fileReader)
    {
        ...
        do
        {
            ...
            model.minRank_xor = new XorInt( DictTypeConvert.ParseInt(str[fileReader.typeName2Index["minRank"]]),fileReader.randomUtil);
            model.maxRank_xor = new XorInt( DictTypeConvert.ParseInt(str[fileReader.typeName2Index["maxRank"]]),fileReader.randomUtil);
            ...
            {
                Debug.LogError("DictMenpaibossRankReward Parse:Same Key = " + model.id);
            }

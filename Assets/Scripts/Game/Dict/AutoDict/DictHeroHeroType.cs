...
public partial class DictHeroHeroType
{
    ...
    public Model GetModel(int classId)
    {
        if (m_dict == null)
        {
            Debug.LogError("DictHeroHeroType m_dict Is Null");
            return null;
        }
        else
        {
    ...
    {
        return "dict_hero_hero_type.txt";
    }
    ...
    private void DoParse(DictFileReader fileReader)
    {
        ...
        do
        {
            ...
            {
                Debug.LogError("DictHeroHeroType Parse:Same Key = " + model.classId);
            }

...
public partial class DictRenwuSubDetail
{
    ...
    public Model GetModel(string id)
    {
        if (m_dict == null)
        {
            Debug.LogError("DictRenwuSubDetail m_dict Is Null");
            return null;
        }
        else
        {
    ...
    {
        return "dict_renwu_sub_detail.txt";
    }
    ...
    private void DoParse(DictFileReader fileReader)
    {
        ...
        do
        {
            ...
            model.sub_id = DictTypeConvert.ParseString(str[fileReader.typeName2Index["sub_id"]]);
            ...
            {
                Debug.LogError("DictRenwuSubDetail Parse:Same Key = " + model.id);
            }

...
public partial class DictEquipEquipStar
{
    ...
    public class Model
    {
     ...
     /// <summary>
        /// 消耗自身数量
        /// </summary>
        public XorInt cost_self_num_xor;
     /// <summary>
        /// 消耗自身数量
        /// </summary>
        public int cost_self_num{
            get{
                return cost_self_num_xor.val;
            }
        }
    ...
    public Model GetModel(int id)
    {
        if (m_dict == null)
        {
            Debug.LogError("DictEquipEquipStar m_dict Is Null");
            return null;
        }
        else
        {
    ...
    {
        return "dict_equip_equip_star.txt";
    }
    ...
    private void DoParse(DictFileReader fileReader)
    {
        ...
        do
        {
            ...
            model.cost_self_num_xor = new XorInt( DictTypeConvert.ParseInt(str[fileReader.typeName2Index["cost_self_num"]]),fileReader.randomUtil);
            ...
            {
                Debug.LogError("DictEquipEquipStar Parse:Same Key = " + model.id);
            }

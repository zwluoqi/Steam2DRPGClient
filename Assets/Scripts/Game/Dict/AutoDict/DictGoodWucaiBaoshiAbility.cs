...
public partial class DictGoodWucaiBaoshiAbility
{
    ...
    public class Model
    {
     ...
     /// <summary>
        /// 需要的星星
        /// </summary>
        public XorInt needStar_xor;
     /// <summary>
        /// 需要的星星
        /// </summary>
        public int needStar{
            get{
                return needStar_xor.val;
            }
        }
     /// <summary>
        /// 星星能力ID
    ...
    public Model GetModel(int id)
    {
        if (m_dict == null)
        {
            Debug.LogError("DictGoodWucaiBaoshiAbility m_dict Is Null");
            return null;
        }
        else
        {
    ...
    {
        return "dict_good_wucai_baoshi_ability.txt";
    }
    ...
    private void DoParse(DictFileReader fileReader)
    {
        ...
        do
        {
            ...
            model.goodId = DictTypeConvert.ParseString(str[fileReader.typeName2Index["goodId"]]);
            model.needStar_xor = new XorInt( DictTypeConvert.ParseInt(str[fileReader.typeName2Index["needStar"]]),fileReader.randomUtil);
            ...
            {
                Debug.LogError("DictGoodWucaiBaoshiAbility Parse:Same Key = " + model.id);
            }

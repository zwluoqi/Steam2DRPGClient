...
public partial class DictRechargeType
{
    ...
    public Model GetModel(int classId)
    {
        if (m_dict == null)
        {
            Debug.LogError("DictRechargeType m_dict Is Null");
            return null;
        }
        else
        {
    ...
    private void DoParse(DictFileReader fileReader)
    {
        ...
        do
        {
            ...
            {
                Debug.LogError("DictRechargeType Parse:Same Key = " + model.classId);
            }

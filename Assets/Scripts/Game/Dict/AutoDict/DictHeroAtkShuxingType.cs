...
public partial class DictHeroAtkShuxingType
{
    ...
    public Model GetModel(int id)
    {
        if (m_dict == null)
        {
            Debug.LogError("DictHeroAtkShuxingType m_dict Is Null");
            return null;
        }
        else
        {
    ...
    {
        return "dict_hero_atk_shuxing_type.txt";
    }
    ...
    private void DoParse(DictFileReader fileReader)
    {
        ...
        do
        {
            ...
            {
                Debug.LogError("DictHeroAtkShuxingType Parse:Same Key = " + model.id);
            }

...
public partial class DictZhaomuZhaomuDropItem
{
    ...
    public class Model
    {
     ...
     /// <summary>
        /// 招募类型
        /// </summary>
        public XorInt zhaomu_type_xor;
     /// <summary>
        /// 招募类型
        /// </summary>
        public int zhaomu_type{
            get{
                return zhaomu_type_xor.val;
            }
        }
    ...
    public Model GetModel(int id)
    {
        if (m_dict == null)
        {
            Debug.LogError("DictZhaomuZhaomuDropItem m_dict Is Null");
            return null;
        }
        else
        {
    ...
    {
        return "dict_zhaomu_zhaomu_drop_item.txt";
    }
    ...
    private void DoParse(DictFileReader fileReader)
    {
        ...
        do
        {
            ...
            model.zhaomu_type_xor = new XorInt( DictTypeConvert.ParseInt(str[fileReader.typeName2Index["zhaomu_type"]]),fileReader.randomUtil);
            ...
            {
                Debug.LogError("DictZhaomuZhaomuDropItem Parse:Same Key = " + model.id);
            }

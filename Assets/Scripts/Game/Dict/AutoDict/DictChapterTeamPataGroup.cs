...
public partial class DictChapterTeamPataGroup
{
    ...
    public Model GetModel(int id)
    {
        if (m_dict == null)
        {
            Debug.LogError("DictChapterTeamPataGroup m_dict Is Null");
            return null;
        }
        else
        {
    ...
    {
        return "dict_chapter_team_pata_group.txt";
    }
    ...
    private void DoParse(DictFileReader fileReader)
    {
        ...
        do
        {
            ...
            model.open_days = DictTypeConvert.ParseArrayInt(str[fileReader.typeName2Index["open_days"]]);
            model.chapterId = DictTypeConvert.ParseString(str[fileReader.typeName2Index["chapterId"]]);
            ...
            {
                Debug.LogError("DictChapterTeamPataGroup Parse:Same Key = " + model.id);
            }

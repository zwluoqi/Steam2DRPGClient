...
public partial class DictRandomStory
{
    ...
    public Model GetModel(int id)
    {
        if (m_dict == null)
        {
            Debug.LogError("DictRandomStory m_dict Is Null");
            return null;
        }
        else
        {
    ...
    private void DoParse(DictFileReader fileReader)
    {
        ...
        do
        {
            ...
            model.taskId = DictTypeConvert.ParseString(str[fileReader.typeName2Index["taskId"]]);
            ...
            {
                Debug.LogError("DictRandomStory Parse:Same Key = " + model.id);
            }

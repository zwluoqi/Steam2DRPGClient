...
public partial class DictHeroRelationType
{
    ...
    public Model GetModel(int classId)
    {
        if (m_dict == null)
        {
            Debug.LogError("DictHeroRelationType m_dict Is Null");
            return null;
        }
        else
        {
    ...
    {
        return "dict_hero_relation_type.txt";
    }
    ...
    private void DoParse(DictFileReader fileReader)
    {
        ...
        do
        {
            ...
            {
                Debug.LogError("DictHeroRelationType Parse:Same Key = " + model.classId);
            }

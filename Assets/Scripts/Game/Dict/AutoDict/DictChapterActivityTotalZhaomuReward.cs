...
public partial class DictChapterActivityTotalZhaomuReward
{
    ...
    public class Model
    {
     ...
     /// <summary>
        /// 招募次数
        /// </summary>
        public XorLong zhaomuCounter_xor;
     /// <summary>
        /// 招募次数
        /// </summary>
        public long zhaomuCounter{
            get{
                return zhaomuCounter_xor.val;
            }
        }
     /// <summary>
        /// 奖励档位
    ...
    public Model GetModel(int id)
    {
        if (m_dict == null)
        {
            Debug.LogError("DictChapterActivityTotalZhaomuReward m_dict Is Null");
            return null;
        }
        else
        {
    ...
    {
        return "dict_chapter_activity_total_zhaomu_reward.txt";
    }
    ...
    private void DoParse(DictFileReader fileReader)
    {
        ...
        do
        {
            ...
            model.zhaomuCounter_xor = new XorLong(DictTypeConvert.ParseLong(str[fileReader.typeName2Index["zhaomuCounter"]]),fileReader.randomUtil);
            ...
            {
                Debug.LogError("DictChapterActivityTotalZhaomuReward Parse:Same Key = " + model.id);
            }

...
public partial class DictRenwuSub
{
    ...
    public Model GetModel(string id)
    {
        if (m_dict == null)
        {
            Debug.LogError("DictRenwuSub m_dict Is Null");
            return null;
        }
        else
        {
    ...
    private void DoParse(DictFileReader fileReader)
    {
        ...
        do
        {
            ...
            model.main_id = DictTypeConvert.ParseString(str[fileReader.typeName2Index["main_id"]]);
            ...
            {
                Debug.LogError("DictRenwuSub Parse:Same Key = " + model.id);
            }
